...
switch (_var) do
{
	...
	case "life_inv_goldbar": {"Registrierter Goldbarren"};
	case "life_inv_gold": {"Goldstueck "};
	case "life_inv_goldr": {"Goldbarren"};
	case "life_inv_coal": {"Unverarbeitete Kohle"};
	case "life_inv_blastingcharge": {"Blasting Charge"};
	case "life_inv_silver": {"Silberstueck"};
	case "life_inv_boltcutter": {"Bolt Cutter"};
	case "life_inv_silverr": {"Silberbarren"};
	case "life_inv_defusekit": {"Bomb Defusal Kit"};
	case "life_inv_frog": {"Frosch"};
	case "life_inv_froglsd": {"Frosch-LSD"};
	...
	case "life_inv_bandage": {"Druckverband"};
	case "life_inv_morphine": {"Morphium"};
	case "life_inv_medkit": {"Erste-Hilfe Koffer"};
	...
	case "license_civ_grapes": {"Traubenverarbeitung"};
	case "license_civ_moonshine": {"Alkoholverarbeitung"};
