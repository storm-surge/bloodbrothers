...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","peaches_1","peaches_2","peaches_3","peaches_4","heroin_1","cocaine_1","weed_1","lead_1","iron_1","salt_1","sand_1","diamond_1","oil_1","oil_2","rock_1","grape_1","grape_2","gold_1","gold_2","silver_1","coal_1","coal_2"];
_zone = "";
...
_item = switch(true) do {
	...
	case (_zone in ["grape_1","grape_2"]): {"grapes"};
	case (_zone in ["rock_1"]): {"rock"};
	case (_zone in ["gold_1","gold_2"]): {"gold"};
	case (_zone in ["coal_1","coal_2"]): {"coal"};
...
while {true} do {
	...
	//Wait for 20 seconds with a 'delta-time' wait.
	waitUntil {
