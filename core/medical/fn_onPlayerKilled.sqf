...
if(!life_use_atm && {life_bargeld > 0}) then {
[format["$%1 from the Federal Reserve robbery was returned from the robber being killed.",[life_bargeld] call life_fnc_numberText],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
life_bargeld = 0;
};
};
