...
switch (life_taxi_location) do
{
	...
	case "taxi_spawn_pyrgosp":
	{
		ctrlSetText[48401,"Pyrgos Taxi Stand"];
	};
	case "taxi_spawn_sofiap":
	{
		ctrlSetText[48401,"HW Patrol Taxi Stand"];
	};
	case "taxi_spawn_airfieldp":
	{
		ctrlSetText[48401,"Air HQ Taxi Stand"];
	};
	case "taxi_spawn_rebhq":
	{
		ctrlSetText[48401,"Rebel HQ Taxi Stand"];
	};
	case "taxi_spawn_rebnw":
	{
		ctrlSetText[48401,"NW Rebel Outpost Taxi Stand"];
	};
	case "taxi_spawn_rebse":
	{
		ctrlSetText[48401,"SE Rebel Outpost Taxi Stand"];
	};
	case "taxi_spawn_impound":
	{
		ctrlSetText[48401,"Impound Lot Taxi Stand"];
	};
};
