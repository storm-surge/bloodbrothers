...
*/
if(life_cgar_inUse) exitWith {hint "An action is already being processed..."};
...
{
	hint "Das koennen nur Zivilisten!";
};
...
_control = ((findDisplay 39400) displayCtrl 39402);
{
	if(alive _x) then {
		...
		_ind = [_className,(call life_chopshop_sell)] call fnc_index;
