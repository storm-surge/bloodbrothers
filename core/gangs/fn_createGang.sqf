...
if(life_kontogeld < (__GETC__(life_gangPrice))) exitWith {hint format[localize "STR_GNOTF_NotEnoughMoney",[((__GETC__(life_gangPrice))-life_kontogeld)] call life_fnc_numberText];};
