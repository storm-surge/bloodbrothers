...
if(life_kontogeld < life_bail_amount) exitWith {hint format["You do not have $%1 in your bank account to pay bail.",life_bail_amount];};

life_kontogeld = life_kontogeld - life_bail_amount;
life_bail_paid = true;
