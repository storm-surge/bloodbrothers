...
switch (_mode) do 
{
	case "heilen":
					{
						if(life_bargeld < 50) exitWith {hint "Du hast keine $50 um geheilt zu werden."};
	...
	case "behandeln":
					 {
						...
						if(life_sex_ill == 1) then
						{
							if(life_bargeld<1000) exitWith { hint "Ich habe bei dir eine Geschlechtskrankheit gefunden du hast nur nicht genug Geld dich behandeln zu lassen!";};
							...
							life_bargeld = life_bargeld - 1000;
							player setDamage 0;
							life_sex_ill = 0;
							life_checked = 0;
						};
						if(life_sex_ill == 2) then
						{
							if(life_bargeld<10000) exitWith { hint "Ich habe bei dir eine Geschlechtskrankheit gefunden du hast nur nicht genug Geld dich behandeln zu lassen!";};
							titleText["Ich habe Aids bei dir entdeckt. Ich werde dich nun heilen. \n Das kann bis zu 45 Sekunden dauern.","PLAIN"];
							sleep 45;
							titleText["Du bist geheilt! Du solltest besser aufpassen!","PLAIN"];
							life_bargeld = life_bargeld - 10000;
							player setDamage 0;
							life_sex_ill = 0;
							life_checked = 0;
						};
