...
_Btn8 ctrlSetText localize "STR_pInAct_Drugtest";
_Btn8 buttonSetAction "[life_pInact_curTarget] call life_fnc_drugtestAction;";

_Btn9 ctrlSetText localize "STR_pInAct_Entwaffnen";
_Btn9 buttonSetAction "[life_pInact_curTarget] call life_fnc_seizePlayerWeapon;";

_Btn10 ctrlSetText localize "STR_pInAct_Entwaffnen2";
_Btn10 buttonSetAction "[life_pInact_curTarget] call life_fnc_seizeObjects;";
