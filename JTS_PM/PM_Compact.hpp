...
class JTS_PM
{
	...
	controls[] = {JTS_DESCTEXT,JTS_INBOX,JTS_SEND,JTS_EDIT,JTS_STAT,JTS_EDIT_TITLE,JTS_INFOTEXT,JTS_TYPING,JTS_TXT1,JTS_TXT2,BUT1,BUT2,BUT3,BUT4,BUT5,BUT6,BUT7,BUT8,BUT9};
	...
	class JTS_STAT: JTS_RscCombo
	{
		...
		toolTip = "Smartphone Einschalten - Auschalten";
		wholeHeight = 0.2 * SafeZoneH;
		x = 0.395 * SafeZoneW + SafeZoneX;
		y = 0.25 * SafeZoneH + SafeZoneY;
		w = 0.095 * SafeZoneW;
	...
	class JTS_EDIT_TITLE: JTS_RscEdit
	{
		idc = 00006;
		text = "name player;";
		toolTip = "Gebe hier den Betreff ein. Maximal 15 Zeichen.";
		x = 0.21 * SafeZoneW + SafeZoneX;
	...
	///////////////////////////////////
	///////////////////////////////////
	class BUT4: JTS_RscButton
	{
		idc = 00013;
		text = "an COPS";
		toolTip = "BETREFF DEAKTIVIERT";
		action = "[] spawn JTS_FNC_SEND_COP";
		onButtonClick = "[] call fnc_cell_textcop";
		x = 0.3025 * SafeZoneW + SafeZoneX;
		y = 0.805 * SafeZoneH + SafeZoneY;
	};

	class BUT5: JTS_RscButton
	{
		idc = 00014;
		text = "an ADMINS";
		toolTip = "BETREFF DEAKTIVIERT";
		action = "[] spawn JTS_FNC_SEND_ADMIN";
	...
	class BUT6: JTS_RscButton
	{
		idc = 00015;
		text = "ADMIN->ALLE";
		toolTip = "BETREFF DEAKTIVIERT";
		action = "[] spawn JTS_FNC_SEND_ADMIN_ALL";
	...
	class BUT7: JTS_RscButton
	{
		idc = 00016;
		text = "COP->ALLE";
		toolTip = "BETREFF DEAKTIVIERT";
		action = "[] spawn JTS_FNC_SEND_COP_ALL";
		onButtonClick = "[] call fnc_cell_copmsgall";
		x = 0.2 * SafeZoneW + SafeZoneX;
		y = 0.873 * SafeZoneH + SafeZoneY;
	};
	class BUT8: JTS_RscButton
	{
		idc = 00017;
		text = "USER->ADAC";
		toolTip = "BETREFF DEAKTIVIERT";
		action = "[] spawn JTS_FNC_SEND_USER_ADAC";
		onButtonClick = "[] call fnc_cell_textadac";
		x = 0.3025 * SafeZoneW + SafeZoneX;
		y = 0.873 * SafeZoneH + SafeZoneY;
	};
	class BUT9: JTS_RscButton
	{
		idc = 00018;
		text = "USER->ATEAM";
		toolTip = "BETREFF DEAKTIVIERT";
		action = "[] spawn JTS_FNC_SEND_ATEAM";
		onButtonClick = "[] call fnc_cell_textateam";
		//onButtonClick="[true] spawn life_fnc_cellex_sendClick;";
		//onButtonClick = "[] call fnc_cell_textadmin";
		x = 0.2 * SafeZoneW + SafeZoneX;
